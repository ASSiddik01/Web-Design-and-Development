...
/*Foreach Loop 
	1. This loop is unique loop.This loop is not available in other programming language only in PHP
*/
...
/*Function*/
	...
	$filtered_array = array_unique($number);
